...
const detailsImageTitleContainer = document.querySelector('#image-name-container');
const productDetailsInfoContainer = document.querySelector('#product-details-info-container');


// ***** all gnome photos, names and descriptions from https://www.target.com/ *****
const gnomes = [
    {
        id: 1,
        detailsLink: '',
...
function loadAllProducts() {
    for (let i = 0; i < gnomes.length; i++) {
        ...
        <div class="product-card">
            ...
            <a href="/html/productDetails.html" class="product-name">
...
function loadProductDetailsPage() {
    ...
    <div class="name-image-container">
        <div>
            ...
            <h4 class="product-name">${gnomes[3].name}</h4>
            </a>
        </div>
        <div>
            <p class="product-stars">
